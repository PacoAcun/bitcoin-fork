...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    switch (chain) {
    case ChainType::MAIN:
        return std::make_unique<CBaseChainParams>("", 9665);
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 19665);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 49665);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 39665);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 19865);
    }
    assert(false);
}
